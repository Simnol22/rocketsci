...
RUN conan install . --update --build=missing -s compiler.version=10 -s compiler.libcxx=libstdc++11 -c tools.system.package_manager:mode=install -s build_type=Release
